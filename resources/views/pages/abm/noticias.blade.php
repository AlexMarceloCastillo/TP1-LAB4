        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="" action="/crear/noticia" method="POST" enctype="multipart/form-data">
                    ...
                    <hr>
                    <label for="contenido_html"> <a href="/contenido" target="_blank">Contenido HTML Automatico</a>
                    </label>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input type="datetime-local" name="fecha_publicacion" class="form-control" required>
                    </div>
